...
public class CredentialIssuerService {
  ...
  // used for testing
  public CredentialIssuerService(
      DataStore<UserIssuedCredentialsItem> dataStore, ConfigurationService configurationService) {
  ...
  public BearerAccessToken exchangeCodeForToken(
    ...
    try {
      ...
      if (tokenResponse instanceof TokenErrorResponse) {
        ...
        ErrorObject errorObject =
            Objects.requireNonNullElse(
                errorResponse.getErrorObject(), new ErrorObject("unknown", "unknown"));
      ...
      throw new CredentialIssuerException(
          HTTPResponse.SC_SERVER_ERROR, ErrorResponse.FAILED_TO_EXCHANGE_AUTHORIZATION_CODE);
    }
  }
  ...
  public JSONObject getCredential(BearerAccessToken accessToken, CredentialIssuerConfig config) {
    ...
    try {
      ...
      if (!response.indicatesSuccess()) {
        ...
        throw new CredentialIssuerException(
            HTTPResponse.SC_SERVER_ERROR, ErrorResponse.FAILED_TO_GET_CREDENTIAL_FROM_ISSUER);
      }
