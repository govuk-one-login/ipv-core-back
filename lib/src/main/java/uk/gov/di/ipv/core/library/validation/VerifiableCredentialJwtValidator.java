...
public class VerifiableCredentialJwtValidator {
    ...
    public void validate(
            ...
            String issuerComponentId,
            ECKey issuerSigningKey,
            String userId)
            throws VerifiableCredentialException {
        validateSignature(verifiableCredential, issuerSigningKey);
        validateClaimsSet(verifiableCredential, issuerComponentId, userId);
    ...
    public void validate(
        ...
        validate(verifiableCredential, credentialIssuerConfig.getComponentId(), signingKey, userId);
    }
