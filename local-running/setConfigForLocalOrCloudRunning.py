...
def get_local_running_params(environment, dev_account):
    return [
        ...
        Param(f"/{environment}/core/credentialIssuers/bav/connections/local/authorizeUrl", "http://localhost:3012/authorize"),
        ...
        Param(f"/{environment}/core/credentialIssuers/bav/connections/local/tokenUrl", "http://host.docker.internal:3012/token"),
        Param(f"/{environment}/core/credentialIssuers/bav/connections/local/credentialUrl", "http://host.docker.internal:3012/credentials/issue"),
