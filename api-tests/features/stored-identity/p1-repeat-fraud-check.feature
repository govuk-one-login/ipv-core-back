...
Rule: No existing SI record for user
  ...
  Scenario Outline: Fraud 6 Months Expiry + Address and Name Change - <selected-name-change> - meets P3
    ...
    Examples:
      ...
      | family-name-and-address | kenneth-changed-family-name-passport-valid | kenneth-changed-family-name-score-2 |
      | given-names-and-address | kenneth-changed-given-name-passport-valid  | kenneth-changed-given-name-score-2  |
