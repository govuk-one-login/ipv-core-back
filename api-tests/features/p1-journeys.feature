...
Feature: P1 journey
  ...
  Scenario: P1 Validate the Evidence requested for medium confidence journey in Experian KBV
    Given I activate the 'p1Journeys' feature set
  ...
  Scenario: P1 Validate the Evidence requested for medium confidence journey in DWP KBV
    Given I activate the 'p1Journeys,dwpKbvTest' feature set
    When I start a new 'medium-confidence' journey
    Then I get a 'page-ipv-identity-document-start' page response
    When I submit an 'appTriage' event
  ...
  Scenario: P1 Validate the Evidence requested for medium confidence journey in HMRC KBV
    Given I activate the 'p1Journeys,m2bBetaHmrcKbv' feature set
    When I start a new 'medium-confidence' journey
    Then I get a 'page-ipv-identity-document-start' page response
    When I submit an 'appTriage' event
