    ...
    public IpvSessionItem generateIpvSession(
        ...
        if (errorObject == null) {
            if (isReverification) {
                ...
                // Currently reverifcation journeys don't check the user's existing profile so we have to hard code this
                // to P2 here. Eventually this can be set in the first step of the reverification journey.
