...
public interface VcFixtures {
    ...
    List<TestVc.TestEvidence> FRAUD_EVIDENCE_FAILED_COUNTRY_DATA_CHECK_DETAILS =
            List.of(
                    TestVc.TestEvidence.builder()
                            .checkDetails(null)
                            .failedCheckDetails(
    ...
    VerifiableCredential M1C_EXPERIAN_FRAUD_VC =
            generateVerifiableCredential(
                    ...
                    Cri.EXPERIAN_FRAUD,
                    TestVc.builder()
                            .evidence(FRAUD_EVIDENCE_FAILED_COUNTRY_DATA_CHECK_DETAILS)
                            .credentialSubject(
                                    TestVc.TestCredentialSubject.builder()
                                            .address(List.of(ADDRESS_3))
                                            .birthDate(List.of(createBirthDate("1959-08-23")))
    ...
    static VerifiableCredential vcFraudCountryDataFailed() {
        TestVc.TestCredentialSubject credentialSubject =
                TestVc.TestCredentialSubject.builder()
                        .address(List.of(ADDRESS_3))
                        .birthDate(List.of(createBirthDate("1959-08-23")))
