...
public class LambdaHttpServer {
    ...
    public LambdaHttpServer(RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> handler, String path, int port) throws IOException {
    ...
    // This class converts between HTTP requests and responses and AWS's APIGatewayProxyRequestEvent and APIGatewayProxyResponseEvent
    private class LambdaHandlerWrapper implements HttpHandler {
        ...
        public LambdaHandlerWrapper(RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> handler) {
