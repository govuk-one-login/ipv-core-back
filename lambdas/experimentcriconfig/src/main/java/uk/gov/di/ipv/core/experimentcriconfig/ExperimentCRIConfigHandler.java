...
public class ExperimentCRIConfigHandler
    ...
    public ExperimentCRIConfigHandler() {
        if (isRunningLocally()) {
            this.ssmProvider =
    ...
    public APIGatewayProxyResponseEvent handleRequest(
        ...
        try {
            List<CredentialIssuerConfig> config = getCredentialIssuers();
    ...
    @Tracing
    private List<CredentialIssuerConfig> getCredentialIssuers()
