...
public class CheckExistingIdentityHandler
    ...
    private JourneyResponse getJourneyResponse(
        ...
        try {
            ...
            if (profileMatchResponse.isPresent()) {
                ...
                ipvSessionItem.setTargetVot(clientOAuthSessionItem.getParsedVtr().getLowestStrengthRequestedVot(configService));
                ipvSessionService.updateIpvSession(ipvSessionItem);
    ...
    private boolean achievedWithGpg45Profile(
        ...
        var isBreaching = ciMitUtilityService.isBreachingCiThreshold(contraIndicators, requestedVot);
    ...
    private boolean hasOperationalProfileVc(Vot requestedVot, List<VerifiableCredential> vcs, ContraIndicators contraIndicators)
