...
class SelectCriHandlerTest {
    ...
    //                        new VisitedCredentialIssuerDetailsDto(CRI_ADDRESS, false,
    // "access_denied"));
    //
    //        when(mockIpvSessionItem.getVisitedCredentialIssuerDetails())
    //                .thenReturn(visitedCredentialIssuerDetails);
    ...
    //        when(mockIpvSessionItem.getVisitedCredentialIssuerDetails())
    //                .thenReturn(List.of(new VisitedCredentialIssuerDetailsDto("dcmaw", true,
    // null)));
    //
    //        when(mockConfigurationService.getSsmParameter(DCMAW_ENABLED)).thenReturn("true");
    //        when(mockConfigurationService.getSsmParameter(DCMAW_SHOULD_SEND_ALL_USERS))
    ...
    //                                new VisitedCredentialIssuerDetailsDto(CRI_ADDRESS, true,
    // null)));
    //
    //        when(mockConfigurationService.getSsmParameter(DCMAW_ENABLED)).thenReturn("true");
    //        when(mockConfigurationService.getSsmParameter(DCMAW_SHOULD_SEND_ALL_USERS))
    ...
    //    @Test
    //    void
    // shouldReturnPyiNoMatchJourneyResponseIfUserHasVisitedDcmawAndAddressAndFraudSuccessfully()
    //            throws JsonProcessingException, URISyntaxException {
    //        mockIpvSessionService();
    //
    //        String userId = "test-user-id";
    ...
    //                                new VisitedCredentialIssuerDetailsDto(CRI_ADDRESS, true,
    // null),
    //                                new VisitedCredentialIssuerDetailsDto(CRI_FRAUD, true,
    // null)));
    //
    //        when(mockIpvSessionItem.getCurrentVcStatuses())
    //                .thenReturn(
    ...
    //                .thenReturn(
    //                        List.of(
    //                                new VisitedCredentialIssuerDetailsDto("ukPassport", true,
    // null),
