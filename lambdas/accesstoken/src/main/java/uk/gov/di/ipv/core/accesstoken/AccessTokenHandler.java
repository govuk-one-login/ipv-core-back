...
public class AccessTokenHandler
  ...
  public AccessTokenHandler(
      AccessTokenService accessTokenService, AuthorizationCodeService authorizationCodeService) {
    ...
    try {
      ...
      String authorizationCodeFromRequest =
          ((AuthorizationCodeGrant) tokenRequest.getAuthorizationGrant())
              ...
              .getValue();
      String ipvSessionId =
          authorizationCodeService.getIpvSessionIdByAuthorizationCode(authorizationCodeFromRequest);
      ...
      return ApiGatewayResponseGenerator.proxyJsonResponse(
          getHttpStatusCodeForErrorResponse(e.getErrorObject()), e.getErrorObject().toJSONObject());
    }
  }
