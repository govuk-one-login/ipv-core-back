...
public class CredentialIssuerConfigHandler
  ...
  public APIGatewayProxyResponseEvent handleRequest(
    ...
    passportStubCri.put(
        "authorizeUrl", "https://di-ipv-credential-issuer-stub.london.cloudapps.digital/authorize");
    passportStubCri.put(
    ...
    passportStubCri.put(
        "credentialUrl", "https://psgeggxp8j.execute-api.eu-west-2.amazonaws.com/dev/credential");
    passportStubCri.put("ipvClientId", "IPV-Core");
