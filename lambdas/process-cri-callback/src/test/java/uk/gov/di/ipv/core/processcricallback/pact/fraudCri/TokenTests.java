...
class TokenTests {
    ...
    public RequestResponsePact validRequestReturnsValidAccessToken(PactDslWithProvider builder) {
        return builder.given("dummyAuthCode is a valid authorization code")
                ...
                .method("POST")
                .body(
                        "client_assertion_type=urn%3Aietf%3Aparams%3Aoauth%3Aclient-assertion-type%3Ajwt-bearer&code=dummyAuthCode&grant_type=authorization_code&redirect_uri=https%3A%2F%2Fidentity.staging.account.gov.uk%2Fcredential-issuer%2Fcallback%3Fid%3Dfraud&client_assertion=" // pragma: accesslist secret
    ...
    private static final String CLIENT_ASSERTION_SIGNATURE =
            "LV74cQ6gFe5BjOmA8Xm43y1GIK7gQja66Ei355gpfPPJqsdUX1TvnyIhC3U3S1nW5bqV-kxqRuAbmfQb9N0R4w";
}
