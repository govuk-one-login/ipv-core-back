...
| `reset-identity`        | `/journey/reset-identity`           | Resets a set or all of a user's VCs from the sessions credential store based on the input to the lambda. Can also reinstate a user's VCs from EVCS.                                                                                                                                     |
