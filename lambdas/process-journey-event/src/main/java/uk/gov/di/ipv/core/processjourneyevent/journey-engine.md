...
| `reset-identity`                | `/journey/reset-identity`                   | Resets identity state: clears session VCs (all or a subset based on reset type) and abandons any stored identity record or pending identity in EVCS                                                                                                                                     |
