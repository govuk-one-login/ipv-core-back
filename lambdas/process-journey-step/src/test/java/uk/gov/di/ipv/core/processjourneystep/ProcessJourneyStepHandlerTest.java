...
class ProcessJourneyStepHandlerTest {
    ...
    // ByteArrayInputStream(objectMapper.writeValueAsBytes(input));
    ...
    //        assertEquals(ErrorResponse.INVALID_SESSION_ID.getMessage(),
    // outputBody.get("message"));
    //    }
    //
    //    @Test
    ...
    //        assertEquals(ErrorResponse.FAILED_JOURNEY_ENGINE_STEP.getCode(),
    // outputBody.get("code"));
    //        assertEquals(
    //                ErrorResponse.FAILED_JOURNEY_ENGINE_STEP.getMessage(),
    // outputBody.get("message"));
    //    }
    //
    //    @Test
    ...
    //                ArgumentCaptor.forClass(IpvSessionItem.class);
    //        verify(mockIpvSessionService).updateIpvSession(sessionArgumentCaptor.capture());
    //        assertEquals(RETRIEVE_CRI_CREDENTIAL,
    // sessionArgumentCaptor.getValue().getUserState());
    //
    //        assertEquals(200, lambdaOutput.getStatusCode());
    ...
    //                ArgumentCaptor.forClass(IpvSessionItem.class);
    //        verify(mockIpvSessionService).updateIpvSession(sessionArgumentCaptor.capture());
    //        assertEquals(DEBUG_EVALUATE_GPG45_SCORES,
    // sessionArgumentCaptor.getValue().getUserState());
    //
    //        assertEquals(200, lambdaOutput.getStatusCode());
    ...
    //        assertEquals(CORE_SESSION_TIMEOUT_STATE,
    // sessionArgumentCaptor.getValue().getUserState());
